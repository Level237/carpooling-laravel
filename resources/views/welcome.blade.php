		...
		<div class="rounded-3 p-3 p-sm-5" style="background-image: url(assets/images/bg/01.jpg); background-position: center center; background-repeat: no-repeat; background-size: cover;">
			...
			<div class="row">
				<div class="col-md-10 mx-auto text-center">
					<h1 class="text-dark display-3 pt-sm-5 my-5">Pret à partir?</h1>
				</div>
			</div>
				...
				<div class="card card-img-scale overflow-hidden bg-transparent">
					...
					<div class="card-body px-2">
						...
						<div class="d-flex justify-content-between align-items-center">
							<h5 class="card-title"><a href="flight-list.html.htm" class="stretched-link">Thailand</a></h5>
			...
			<div class="col-sm-6 col-lg-3">
				...
				<div class="card card-img-scale overflow-hidden bg-transparent">
					...
					<div class="card-body px-2">
						<!-- Title -->
						<div class="d-flex justify-content-between align-items-center">
							<h5 class="card-title"><a href="flight-list.html.htm" class="stretched-link">Hong Kong</a></h5>
			...
			<div class="col-sm-6 col-lg-3">
				...
				<div class="card card-img-scale overflow-hidden bg-transparent">
					...
					<div class="card-body px-2">
						<!-- Title -->
						<div class="d-flex justify-content-between align-items-center">
							<h5 class="card-title"><a href="flight-list.html.htm" class="stretched-link">Maldives</a></h5>
							<h6 class="mb-0">4.3<i class="fas fa-star text-warning ms-1"></i></h6>
						</div>
						<!-- Content -->
			...
			<div class="col-sm-6 col-lg-3">
				...
				<div class="card card-img-scale overflow-hidden bg-transparent">
					...
					<div class="card-body px-2">
						<!-- Title -->
						<div class="d-flex justify-content-between align-items-center">
							<h5 class="card-title"><a href="flight-list.html.htm" class="stretched-link">Switzerland</a></h5>
							<h6 class="mb-0">4.3<i class="fas fa-star text-warning ms-1"></i></h6>
						</div>
						<!-- Content -->
		...
		<div class="bg-light rounded-3 position-relative p-4 p-sm-5">
			...
			<div class="row align-items-center position-relative">
				...
				<div class="col-lg-4 text-lg-end">
					<a href="flight-list.html.htm" class="btn btn-lg btn-dark mb-0">Book a Flight</a>
				</div>
			</div> <!-- Row END -->
		</div>
	</div>
			...
			<div class="col-md-6">
				...
				<div class="card bg-transparent">
					...
					<div class="card-body px-3">
						<h4><a href="blog-detail.html.htm" class="stretched-link">10 Ways on How to Improve your Hotel Operations</a></h4>
					</div>
				</div>
				<!-- Card END -->
			</div>
					...
					<div class="row align-items-center">
						...
						<div class="col-sm-8">
							...
							<div class="card-body p-sm-0">
								<h5 class="card-title"><a href="blog-detail.html.htm" class="stretched-link">Story of water world adventure</a></h5>
				...
				<div class="card bg-transparent mb-4 mb-md-5">
					<div class="row align-items-center">
						...
						<div class="col-sm-8">
							<!-- card body -->
							<div class="card-body p-sm-0">
								<h5 class="card-title"><a href="blog-detail.html.htm" class="stretched-link">How Hotel Technology Can Help Small Hotel Businesses</a></h5>
				...
				<div class="card bg-transparent mb-0 mb-md-5">
					<div class="row align-items-center">
						...
						<div class="col-sm-8">
							<!-- card body -->
							<div class="card-body p-sm-0">
								<h5 class="card-title"><a href="blog-detail.html.htm" class="stretched-link">Hotel Service - Become a Guide for Your Guests</a></h5>
